...
def parse_arguments(is_training: bool = True):
    ...
    # Model parameters
    parser.add_argument("--method", type=str, default="salad",
                        choices=["netvlad", "sfrs", "cosplace", "convap", "mixvpr", "eigenplaces", "salad"], help="_")
    ...
    parser.add_argument("--real_train_dir", type=str, required=True,
                        help="path of directory with real images")
    parser.add_argument("--synt_train_dir", type=str, required=True,
