...
def save_preds(predictions, eval_ds, log_dir, save_only_wrong_preds=None,
               preds_folder_name="default", positive_dist_threshold=25):
    ...
    for query_index, preds in enumerate(tqdm(predictions, ncols=120, desc=f"Saving preds in {log_dir}")):
